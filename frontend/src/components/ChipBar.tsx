...
export function ChipBar({ stock }: ChipBarProps) {
  ...
  return (
    <div className="grid grid-cols-4 gap-1 mt-2 p-2 bg-gray-800 rounded text-xs">
      <ChipItem label="外資6日" value={fmtK(stock.foreign_6d_net)} positive={stock.foreign_6d_net > 0} />
      <ChipItem label="投信6日" value={fmtK(stock.trust_6d_net)} positive={stock.trust_6d_net > 0} />
