...
> 自動篩選台股電子類股中，股價回檔但主力籌碼未撤的標的，並以儀表板呈現投資建議。
...
> 實證（啟碁 6285）：5/4~5/11 帶寬壓縮（squeeze=True），5/12 突破上軌位階10.3創60日新高
...
| 指標 | 公式 | 來源 | 頻率 |
|------|------|------|------|
| 法人累積買超比率 | (外資+投信買超) / 成交量，拉回期間合計 > 10% | TWSE T86 | 日 |
